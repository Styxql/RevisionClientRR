...
namespace RevisionClient.Services
{
    public class WSService
    {
        ...
        {
            var response = await HttpClient.GetAsync("Pilotes/" + serie.Idpilote);
        ...
        {
            var response = await HttpClient.PutAsJsonAsync("Pilotes/" + pilote.Idpilote, pilote);
            return response.IsSuccessStatusCode;
        }
        public async Task<bool> DeleteSerieAsync(Pilote serie)
        {
            var response = await HttpClient.DeleteAsync("Pilotes/" + serie.Idpilote);
            return response.IsSuccessStatusCode;
        }
